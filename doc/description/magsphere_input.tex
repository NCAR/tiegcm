...
\begin{figure}
	\centering
	\includegraphics[width=\linewidth]{./tex_plot/precipitation.eps}
	\caption{The electron flux of the precipitating electrons in the cusp region, the auroral oval, and the polar cap are modeled with assuming a maxwellian distribution.}
	\label{fig:electronPrecipitation}
\end{figure}
