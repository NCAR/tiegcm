# -*- coding: utf-8 -*-
#
# tiegcm2.0 documentation build configuration file
#
...
exclude_patterns = ['_build','v1.95','save']
...
html_title = "TIEGCM v2.0 Benchmark Results"
#html_title = None
...
latex_documents = [
  ('index', 'tiegcm20.tex', u'tiegcm2.0 Documentation',
   u'NCAR/HAO', 'manual'),
]
...
man_pages = [
    ('index', 'tiegcm195', u'tiegcm2.0 Documentation',
     [u'NCAR/HAO'], 1)
]
