...
from data_parse import lat_lon_lev, lat_lon_ilev,calc_avg_ht, min_max, var_lev, get_avg_ht_arr
...
def plt_lev_var(dataset, variable_name, selected_time, selected_lat, selected_lon):
    ...
    ax2.set_ylabel('AVH HT (in km)', fontsize=28, labelpad=15, color='black')
