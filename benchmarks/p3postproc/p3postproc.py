...
fig1 = plt_lat_lon(datasets, "TN", timestep_array[119][1], -4.0)
fig2 = plt_lat_lon(datasets, "O2", timestep_array[119][1], 0.0)
fig3 = plt_lat_lon(datasets, "VN", timestep_array[119][1], 2.0)
fig4 = plt_lat_lon(datasets, "ZG", timestep_array[119][1], 4.0)
fig5 = plt_lev_var(datasets, "UN", timestep_array[119][1], -62.50, 0.0)
fig6 = plt_lev_var(datasets, "ZG", timestep_array[119][1], -62.50, -180.0)
fig7 =plt_lev_lon(datasets, "ZG", timestep_array[119][1], -62.50)
fig8 =plt_lev_lon(datasets, "UN", timestep_array[119][1], -62.50)
fig9 =plt_lev_lat(datasets, "UN", timestep_array[119][1], 0.0)
fig10 =plt_lev_lat(datasets, "UN", timestep_array[119][1], -180.0)
