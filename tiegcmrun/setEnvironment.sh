#!/usr/bin/env bash
# usage: source setupEnvironment.sh
TIEGCMHOME=""
TIEGCMDATA=""
SYSTEM="" # derecho or atiken (autogenerated)
SAVED_MODULES="" # Name of existing set of modules saved on system 
CONDA_ENV="" # Name of existing conda env
